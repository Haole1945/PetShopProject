...
//        {
//            pstm.setString(1, String.valueOf(hd.getNgTao()));
//            pstm.setString(2,String.valueOf(hd.getTenKH()));
//            pstm.setString(3, String.valueOf(hd.get));
...
//    }
    ...
    public List<DoanhThu> getThang(int nam) throws Exception {
        System.out.print(String.valueOf(nam)+"1");
        String sql = "SELECT  distinct\n"
                ...
                + "ORDER BY thang";
        System.out.print(String.valueOf(nam)+"2 ");
        try (
            Connection con = helper.openConnection(); PreparedStatement pstm = con.prepareStatement(sql);) {
            System.out.print(String.valueOf(nam)+"3");
            System.out.print(String.valueOf(nam));
