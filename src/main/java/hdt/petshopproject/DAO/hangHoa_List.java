...
public class hangHoa_List {
    ...
    public List<hangHoa> getAll() throws Exception {
        String sql = "select * from hangHoa  Where trangThai = 'False' order by ID";
    ...
    public boolean insert(hangHoa hh) throws Exception {
        String sql = "insert into hangHoa(Ten,Loai, giaTien, gioiTinh, ngNhap, chiTiet, trangThai) values (?,?,?, ?, ?,?, ?);";
        try (
