...
//    }
    ...
    private void Sua() {
        ...
        try {
            ...
            if(year.size()>0) jNam.removeAllItems();
            for (int i : year) {
    ...
    public void DTThang() {
        ...
        jPanel5.add(barChart1);
        barChart1.addLegend("Tổng các loai", new Color(245, 189, 135));
    ...
    private void initComponents() {
        ...
        jNam.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                jNamPropertyChange(evt);
            }
        });
...
//        DTThang();
    ...
    private void jNamPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jNamPropertyChange
        // TODO add your handling code here:
        initRevenue();
        DTThang();
    }//GEN-LAST:event_jNamPropertyChange
