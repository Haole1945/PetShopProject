...
public class TabStock extends javax.swing.JPanel {
    ...
    public TabStock() {
        ...
        initTable();
        fillTable();
        setVerticalSB(jScrollPane2, 10,5,35);
        setVerticalSB(jScrollPane1, 10, 10, 100);
    ...
    private void initComponents() {
        ...
        themThuCung.setMinimumSize(new java.awt.Dimension(600, 356));
        themThuCung.setModal(true);
        themThuCung.setSize(new java.awt.Dimension(595, 356));
        ...
        themThuCungLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, themThuCungLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(themThuCungLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void HH_T_LuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HH_T_LuuActionPerformed
        try {
            ...
            dao.insert(hh);
            fillTable();
            JOptionPane.showMessageDialog(themThuCung, "Thêm thành công!!");
